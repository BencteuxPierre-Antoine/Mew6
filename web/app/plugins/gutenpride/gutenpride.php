...
function victories($attrs) {
	...
	return \App\template( __DIR__ . '/views/victories/render.blade.php', $data);
}
...
function create_block_gutenpride_block_init() {
	...
	register_block_type( __DIR__ . '/build/victories', array(
		'render_callback' => 'victories'
	) );
}
